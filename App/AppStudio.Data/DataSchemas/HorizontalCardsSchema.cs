...
{
    /// <summary>
    /// Implementation of the HorizontalCardsSchema class.
    /// </summary>
    public class HorizontalCardsSchema : BindableSchemaBase, IEquatable<HorizontalCardsSchema>, ISyncItem<HorizontalCardsSchema>
    {
        ...
        public bool Equals(HorizontalCardsSchema other)
        {
        ...
        public bool NeedSync(HorizontalCardsSchema other)
        {
        ...
        public void Sync(HorizontalCardsSchema other)
        {
        ...
        {
            return Equals(obj as HorizontalCardsSchema);
        }
