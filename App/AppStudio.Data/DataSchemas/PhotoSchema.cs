...
{
    /// <summary>
    /// Implementation of the PhotoSchema class.
    /// </summary>
    public class PhotoSchema : BindableSchemaBase, IEquatable<PhotoSchema>, ISyncItem<PhotoSchema>
    {
        ...
        public bool Equals(PhotoSchema other)
        {
        ...
        public bool NeedSync(PhotoSchema other)
        {
        ...
        public void Sync(PhotoSchema other)
        {
        ...
        {
            return Equals(obj as PhotoSchema);
        }
