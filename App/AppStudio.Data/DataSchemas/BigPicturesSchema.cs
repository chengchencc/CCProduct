...
{
    /// <summary>
    /// Implementation of the BigPicturesSchema class.
    /// </summary>
    public class BigPicturesSchema : BindableSchemaBase, IEquatable<BigPicturesSchema>, ISyncItem<BigPicturesSchema>
    {
        ...
        public bool Equals(BigPicturesSchema other)
        {
        ...
        public bool NeedSync(BigPicturesSchema other)
        {
        ...
        public void Sync(BigPicturesSchema other)
        {
        ...
        {
            return Equals(obj as BigPicturesSchema);
        }
