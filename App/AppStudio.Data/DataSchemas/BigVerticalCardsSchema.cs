...
{
    /// <summary>
    /// Implementation of the BigVerticalCardsSchema class.
    /// </summary>
    public class BigVerticalCardsSchema : BindableSchemaBase, IEquatable<BigVerticalCardsSchema>, ISyncItem<BigVerticalCardsSchema>
    {
        ...
        public bool Equals(BigVerticalCardsSchema other)
        {
        ...
        public bool NeedSync(BigVerticalCardsSchema other)
        {
        ...
        public void Sync(BigVerticalCardsSchema other)
        {
        ...
        {
            return Equals(obj as BigVerticalCardsSchema);
        }
