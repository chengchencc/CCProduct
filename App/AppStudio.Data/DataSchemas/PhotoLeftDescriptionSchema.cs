...
{
    /// <summary>
    /// Implementation of the PhotoLeftDescriptionSchema class.
    /// </summary>
    public class PhotoLeftDescriptionSchema : BindableSchemaBase, IEquatable<PhotoLeftDescriptionSchema>, ISyncItem<PhotoLeftDescriptionSchema>
    {
        ...
        public bool Equals(PhotoLeftDescriptionSchema other)
        {
        ...
        public bool NeedSync(PhotoLeftDescriptionSchema other)
        {
        ...
        public void Sync(PhotoLeftDescriptionSchema other)
        {
        ...
        {
            return Equals(obj as PhotoLeftDescriptionSchema);
        }
