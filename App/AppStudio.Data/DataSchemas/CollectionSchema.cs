...
{
    /// <summary>
    /// Implementation of the CollectionSchema class.
    /// </summary>
    public class CollectionSchema : BindableSchemaBase, IEquatable<CollectionSchema>, ISyncItem<CollectionSchema>
    {
        ...
        public bool NeedSync(CollectionSchema other)
        {
        ...
        public void Sync(CollectionSchema other)
        {
