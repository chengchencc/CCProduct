...
{
    /// <summary>
    /// Implementation of the BigPhotoSchema class.
    /// </summary>
    public class BigPhotoSchema : BindableSchemaBase, IEquatable<BigPhotoSchema>, ISyncItem<BigPhotoSchema>
    {
        ...
        public bool Equals(BigPhotoSchema other)
        {
        ...
        public bool NeedSync(BigPhotoSchema other)
        {
        ...
        public void Sync(BigPhotoSchema other)
        {
        ...
        {
            return Equals(obj as BigPhotoSchema);
        }
