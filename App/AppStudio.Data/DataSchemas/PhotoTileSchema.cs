...
{
    /// <summary>
    /// Implementation of the PhotoTileSchema class.
    /// </summary>
    public class PhotoTileSchema : BindableSchemaBase, IEquatable<PhotoTileSchema>, ISyncItem<PhotoTileSchema>
    {
        ...
        public bool Equals(PhotoTileSchema other)
        {
        ...
        public bool NeedSync(PhotoTileSchema other)
        {
        ...
        public void Sync(PhotoTileSchema other)
        {
        ...
        {
            return Equals(obj as PhotoTileSchema);
        }
