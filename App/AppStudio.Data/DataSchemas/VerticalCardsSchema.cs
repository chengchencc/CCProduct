...
{
    /// <summary>
    /// Implementation of the VerticalCardsSchema class.
    /// </summary>
    public class VerticalCardsSchema : BindableSchemaBase, IEquatable<VerticalCardsSchema>, ISyncItem<VerticalCardsSchema>
    {
        ...
        public bool Equals(VerticalCardsSchema other)
        {
        ...
        public bool NeedSync(VerticalCardsSchema other)
        {
        ...
        public void Sync(VerticalCardsSchema other)
        {
        ...
        {
            return Equals(obj as VerticalCardsSchema);
        }
