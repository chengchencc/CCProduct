...
{
    /// <summary>
    /// Implementation of the PhotoLeftSchema class.
    /// </summary>
    public class PhotoLeftSchema : BindableSchemaBase, IEquatable<PhotoLeftSchema>, ISyncItem<PhotoLeftSchema>
    {
        ...
        public bool Equals(PhotoLeftSchema other)
        {
        ...
        public bool NeedSync(PhotoLeftSchema other)
        {
        ...
        public void Sync(PhotoLeftSchema other)
        {
        ...
        {
            return Equals(obj as PhotoLeftSchema);
        }
