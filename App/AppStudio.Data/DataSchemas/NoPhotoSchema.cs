...
{
    /// <summary>
    /// Implementation of the NoPhotoSchema class.
    /// </summary>
    public class NoPhotoSchema : BindableSchemaBase, IEquatable<NoPhotoSchema>, ISyncItem<NoPhotoSchema>
    {
        ...
        public bool Equals(NoPhotoSchema other)
        {
        ...
        public bool NeedSync(NoPhotoSchema other)
        {
        ...
        public void Sync(NoPhotoSchema other)
        {
        ...
        {
            return Equals(obj as NoPhotoSchema);
        }
