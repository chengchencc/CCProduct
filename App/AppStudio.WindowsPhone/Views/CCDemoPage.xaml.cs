...
namespace AppStudio.Views
{
    ...
    /// </summary>
    public sealed partial class CCDemoPage : Page
    {
        ...
        {
            if (MaskingLayer.Visibility == Windows.UI.Xaml.Visibility.Collapsed)
                MaskingLayer.Visibility = Windows.UI.Xaml.Visibility.Visible;
            else
                MaskingLayer.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
        }
