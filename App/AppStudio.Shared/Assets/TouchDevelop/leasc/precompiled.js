...
cs.authorId = "unknown";
cs.scriptId = "leasc";
cs.scriptGuid = "539ae405-f755-407d-d789-8c4b8c22d846";
cs.hasLocalData = 1;
cs.reflectionInfo = { actions: [{"textVersion":"v2.2,js,ctx,refs,localcloud,unicodemodel,allasync,upperplex","jsonVersion":"v0.1,resolved","name":"Wabbit Wars","comment":"Rabbit, run away from the turtles!  Pass through gates to destroy turtles and score points. Pick up broken turtle shells to get point multipliers. Eat a carrot to restore health. What a wascally wipoff!","icon":"JoyStick","color":"#ff007fff","autoIcon":"emptycircle","autoColor":"#007fff","platform":"current","rootId":"Ud9u2lA3QH5uM8R6YV2dJZdP","showAd":false,"isLibrary":false,"allowExport":true,"isCloud":false,"hasIds":true,"decls":[{"name":"main","inParameters":[],"outParameters":[],"isPrivate":false,"isTest":false,"isQuery":false,"isOffline":false,"isAsync":true,"description":"","nodeType":"action"}],"nodeType":"app","libraryName":"this","libraryId":"this"}] };
})}
