...
{
    public class BigVerticalCardsViewModel : ViewModelBase<BigVerticalCardsSchema>
    {
        private RelayCommandEx<BigVerticalCardsSchema> itemClickCommand;
        public RelayCommandEx<BigVerticalCardsSchema> ItemClickCommand
        {
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<BigVerticalCardsSchema>(
                        (item) =>
                        {
        ...
        override protected DataSourceBase<BigVerticalCardsSchema> CreateDataSource()
        {
            return new BigVerticalCardsDataSource((Guid)ApplicationData.Current.LocalSettings.Values[LocalSettingNames.StoreIdSetting], ApplicationData.Current.LocalSettings.Values[LocalSettingNames.DeviceTypeSetting] as string); // CollectionDataSource
        }
