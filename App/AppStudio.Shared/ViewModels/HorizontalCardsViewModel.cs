...
{
    public class HorizontalCardsViewModel : ViewModelBase<HorizontalCardsSchema>
    {
        private RelayCommandEx<HorizontalCardsSchema> itemClickCommand;
        public RelayCommandEx<HorizontalCardsSchema> ItemClickCommand
        {
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<HorizontalCardsSchema>(
                        (item) =>
                        {
        ...
        override protected DataSourceBase<HorizontalCardsSchema> CreateDataSource()
        {
            return new HorizontalCardsDataSource((Guid)ApplicationData.Current.LocalSettings.Values[LocalSettingNames.StoreIdSetting], ApplicationData.Current.LocalSettings.Values[LocalSettingNames.DeviceTypeSetting] as string); // CollectionDataSource
        }
