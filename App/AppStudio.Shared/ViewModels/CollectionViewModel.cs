...
{
    public class CollectionViewModel : ViewModelBase<CollectionSchema>
    {
        private RelayCommandEx<CollectionSchema> itemClickCommand;
        public RelayCommandEx<CollectionSchema> ItemClickCommand
        {
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<CollectionSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("CollectionDetail", item);
                        });
                }
        ...
        override protected DataSourceBase<CollectionSchema> CreateDataSource()
        {
            return new CollectionDataSource(); // CollectionDataSource
        }
        ...
        {
            base.PinToStart("CollectionDetail", "{DefaultTitle}", "{DefaultSummary}", "{DefaultImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("CollectionList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("CollectionDetail");
        }
    }
}
