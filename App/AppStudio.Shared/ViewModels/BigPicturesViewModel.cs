...
{
    public class BigPicturesViewModel : ViewModelBase<BigPicturesSchema>
    {
        private RelayCommandEx<BigPicturesSchema> itemClickCommand;
        public RelayCommandEx<BigPicturesSchema> ItemClickCommand
        {
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<BigPicturesSchema>(
                        (item) =>
                        {
        ...
        override protected DataSourceBase<BigPicturesSchema> CreateDataSource()
        {
            return new BigPicturesDataSource((Guid)ApplicationData.Current.LocalSettings.Values[LocalSettingNames.StoreIdSetting], ApplicationData.Current.LocalSettings.Values[LocalSettingNames.DeviceTypeSetting] as string); // CollectionDataSource
        }
