...
{
    public class VerticalCardsViewModel : ViewModelBase<VerticalCardsSchema>
    {
        private RelayCommandEx<VerticalCardsSchema> itemClickCommand;
        public RelayCommandEx<VerticalCardsSchema> ItemClickCommand
        {
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<VerticalCardsSchema>(
                        (item) =>
                        {
        ...
        override protected DataSourceBase<VerticalCardsSchema> CreateDataSource()
        {
            return new VerticalCardsDataSource((Guid)ApplicationData.Current.LocalSettings.Values[LocalSettingNames.StoreIdSetting], ApplicationData.Current.LocalSettings.Values[LocalSettingNames.DeviceTypeSetting] as string); // CollectionDataSource
        }
