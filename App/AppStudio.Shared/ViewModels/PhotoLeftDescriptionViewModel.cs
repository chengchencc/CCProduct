...
{
    public class PhotoLeftDescriptionViewModel : ViewModelBase<PhotoLeftDescriptionSchema>
    {
        private RelayCommandEx<PhotoLeftDescriptionSchema> itemClickCommand;
        public RelayCommandEx<PhotoLeftDescriptionSchema> ItemClickCommand
        {
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<PhotoLeftDescriptionSchema>(
                        (item) =>
                        {
        ...
        override protected DataSourceBase<PhotoLeftDescriptionSchema> CreateDataSource()
        {
            return new PhotoLeftDescriptionDataSource((Guid)ApplicationData.Current.LocalSettings.Values[LocalSettingNames.StoreIdSetting], ApplicationData.Current.LocalSettings.Values[LocalSettingNames.DeviceTypeSetting] as string); // CollectionDataSource
        }
