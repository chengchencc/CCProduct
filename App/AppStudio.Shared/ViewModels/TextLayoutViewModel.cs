...
{
    public class TextLayoutViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TextLayoutDetail", item);
                        });
                }
        ...
        {
            return new TextLayoutDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TextLayoutList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TextLayoutDetail");
        }
    }
}
