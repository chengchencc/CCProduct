...
{
    public class PhotoTileViewModel : ViewModelBase<PhotoTileSchema>
    {
        private RelayCommandEx<PhotoTileSchema> itemClickCommand;
        public RelayCommandEx<PhotoTileSchema> ItemClickCommand
        {
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<PhotoTileSchema>(
                        (item) =>
                        {
        ...
        override protected DataSourceBase<PhotoTileSchema> CreateDataSource()
        {
            return new PhotoTileDataSource(); // CollectionDataSource
        }
