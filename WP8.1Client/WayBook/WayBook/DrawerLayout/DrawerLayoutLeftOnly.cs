...
{
    public class DrawerLayoutLeftOnly : Grid
    {
        ...
        public static readonly DependencyProperty IsDrawerOpenProperty = DependencyProperty.Register("IsDrawerOpen", typeof(bool), typeof(DrawerLayoutLeftOnly), new PropertyMetadata(false));
