...
namespace App1
{
    ...
    public sealed partial class ItemPage : Page
    {
        ...
        private async System.Threading.Tasks.Task BindingData()
        {
            ...
            IncomeContent.Text = "总收入：" + recorder.TotalIncome+"元";
            ExpenditureContent.Text = "总支出：" + recorder.TotalExpenditure + "元";
            ProfitContent.Text = "净收入：" + recorder.Profit + "元";
        ...
        private async void IncomeListViewItem_Tapped(object sender, TappedRoutedEventArgs e)
        {
            AddIncomeContent dialog = new AddIncomeContent();
            dialog.RecorderId = RecorderId;
            dialog.Id = ((RecorderItem)((Windows.UI.Xaml.FrameworkElement)(sender)).DataContext).Id;
        ...
        private async void PurchaseListViewItem_Tapped(object sender, RoutedEventArgs e)
        {
            AddPurchaseContent dialog = new AddPurchaseContent();
            dialog.RecorderId = RecorderId;
            dialog.Id = ((RecorderItem)((Windows.UI.Xaml.FrameworkElement)(sender)).DataContext).Id;
